...
assert.match(sync, /js\/v6-store-browser\.js\?v=6\.0\.0-store-browser\.17/);
...
assert.ok(browser.includes('var strict='), 'Store Browser must apply stricter category/subcategory query filtering');
