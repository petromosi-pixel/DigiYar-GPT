...
var SUBS={
 ...
 laptop:[['laptop-use','دسته‌بندی کاربردی'],['laptop-acer','لپ‌تاپ Acer'],['laptop-macbook','Apple MacBook'],['laptop-asus','لپ‌تاپ ASUS'],['laptop-dell','لپ‌تاپ Dell'],['laptop-hp','لپ‌تاپ HP'],['laptop-msi','لپ‌تاپ MSI'],['laptop-lenovo','لپ‌تاپ Lenovo']],
 ...
 'computer-peripherals':[['speaker','اسپیکر'],['keyboard','کیبورد'],['mouse','موس'],['microphone','میکروفن'],['headset','هدست']],
 ...
 accessories:[['computer-accessories','لوازم جانبی کامپیوتر'],['cable','کابل و مبدل'],['charger','شارژر و آداپتور'],['holder','پایه و هولدر'],['storage-accessories','لوازم حافظه و ذخیره‌سازی']],
 mobile:[['phone','گوشی موبایل'],['tablet','تبلت'],['mobile-accessories','لوازم جانبی موبایل و تبلت']],
 'audio-video':[['earbuds','هندزفری و ایرباد'],['headphone','هدفون و هدست'],['speaker','اسپیکر'],['soundbar','ساندبار و سینمای خانگی'],['tv','تلویزیون']],
