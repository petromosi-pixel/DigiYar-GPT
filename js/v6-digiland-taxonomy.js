...
var STORE='digiland';
var ROOTS=[
 ['stock','سیستم استوک'],['console','کنسول بازی'],['laptop','لپ‌تاپ'],['monitor','مانیتور'],['computer','تجهیزات کامپیوتر'],['gaming','تجهیزات گیمینگ'],['case','کیس'],['accessories','لوازم جانبی'],['mobile','موبایل و تبلت'],['audio','صوتی و تصویری'],['smart','ساعت و گجت هوشمند']
];
var SUBS={
...
var BRANDS={
 'stock-case':['Acer','Dell','HP','Lenovo'],'stock-monitor':['Dell','HP','Lenovo','LG','Samsung'],'stock-laptop':['Dell','HP','Lenovo'],xbox:['مایکروسافت'],'xbox-one':['مایکروسافت'],playstation:['سونی'],'console-games':['سونی','مایکروسافت','نینتندو'],'console-accessories':['سونی','مایکروسافت'],'laptop-use':['ایسوس','لنوو','HP','ایسر','MSI','اپل','دل'],'laptop-acer':['Acer'],'laptop-asus':['ASUS'],'laptop-dell':['Dell'],'laptop-hp':['HP'],'laptop-lenovo':['Lenovo'],'laptop-msi':['MSI'],'laptop-macbook':['Apple'],'monitor-use':['ASUS','LG','MSI','Samsung','AOC','BenQ'],'monitor-asus':['ASUS'],'monitor-lg':['LG'],'monitor-msi':['MSI'],'monitor-samsung':['Samsung'],keyboard:['تسکو','لاجیتک','ای‌فورتک','ردراگون','ریزر','گرین'],mouse:['لاجیتک','ای‌فورتک','تسکو','ردراگون','ریزر'],speaker:['JBL','سونی','انکر','تسکو','هویت'],microphone:['Rode','Shure','Fifine','Maono'],headset:['سونی','JBL','لاجیتک','ریزر','ردراگون'],storage:['Kingston','SanDisk','ADATA','Samsung','Western Digital'],controller:['Sony','Microsoft','Nintendo','8BitDo','Razer','Logitech'],'gaming-chair':['Green','DXRacer','Redragon','TSCO'],'gaming-wheel':['Logitech','Thrustmaster','PXN'],'gaming-desk':['Green','TSCO','Cooler Master'],'computer-case':['Green','DeepCool','Cooler Master','Thermaltake','MSI','ASUS'],'computer-accessories':['تسکو','لاجیتک','بیسوس','یوگرین','گرین'],cable:['بیسوس','انکر','یوگرین','مک‌دودو'],charger:['بیسوس','انکر','سامسونگ','اپل','شیائومی'],holder:['بیسوس','مک‌دودو','جویروم'],phone:['اپل','سامسونگ','شیائومی','آنر','هواوی','موتورولا','نوکیا','وان‌پلاس','اوپو','ریلمی'],tablet:['سامسونگ','اپل','شیائومی','لنوو','هواوی'],'mobile-accessories':['بیسوس','انکر','شیائومی','سامسونگ','اپل','یوگرین','مک‌دودو'],earbuds:['اپل','سامسونگ','JBL','انکر','شیائومی','QCY','هایلو'],headphone:['سونی','JBL','انکر','شیائومی','تسکو'],'audio-speaker':['JBL','سونی','انکر','تسکو','هویت'],soundbar:['سامسونگ','LG','سونی','JBL'],tv:['سامسونگ','LG','سونی','TCL'],smartwatch:['اپل','سامسونگ','شیائومی','هواوی','آمازفیت','گارمین','آنر'],smartband:['شیائومی','هواوی','آمازفیت'],'smart-gadget':['شیائومی','سامسونگ','اپل']
};
function $(id){return document.getElementById(id)}
function selected(){var s=$('storeSelect');return !!(s&&s.value===STORE)}
function removeBrand(){var b=$('v6BrandField');if(b)b.remove()}
function hideDigiLandDuplicateLabels(){
 var card=document.querySelector('.v5-profile-card');
 if(!card)return;
 var texts=['برند','چقدر می‌خوای هزینه کنی؟','چقدر می خوای هزینه کنی؟'];
 Array.from(card.querySelectorAll('label,span,p,div')).forEach(function(el){
   if(el.querySelector('select,input,button'))return;
   var t=(el.textContent||'').trim();
   if(texts.indexOf(t)!==-1)el.style.display='none';
 });
}
function placeDigiLandFields(){
 var sub=$('v5Subcategory'),brandField=$('v6BrandField'),range=$('v6BudgetRange');
 if(!sub)return;
 var subField=sub.closest('.v5-field')||sub.parentNode;
 var budgetField=range&&range.closest('.v5-field');
 var parent=subField&&subField.parentNode;
 if(!parent)return;
 if(brandField)parent.insertBefore(brandField,subField.nextSibling);
 if(budgetField){
   var anchor=brandField||subField;
   parent.insertBefore(budgetField,anchor.nextSibling);
   budgetField.hidden=false;
   budgetField.style.display='flex';
 }
 hideDigiLandDuplicateLabels();
}
