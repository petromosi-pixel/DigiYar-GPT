...
var DOMAINS={
  ...
  digital:['کالای دیجیتال','موبایل','گوشی','لپ تاپ','لپ‌تاپ','تبلت','هدفون','هندزفری','تلویزیون','دوربین','لوازم جانبی','کنسول','گیمینگ','کامپیوتر','مانیتور','پرینتر'],
  fashion:['پوشاک','لباس','کفش','کیف','مد و پوشاک'],
