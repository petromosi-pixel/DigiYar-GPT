...
open('حساب من','<div class="v6-sheet-grid"><button class="v6-sheet-action" type="button" data-scroll="v5ProfileCompletionForm">تکمیل و ویرایش پروفایل</button><button class="v6-sheet-action" type="button" data-scroll="profileForm">تنظیمات خرید و ترجیحات</button></div>');
