...
(function(){
'use strict';
const hints=['🧠 هوش‌یار ، مغز متفکر دیجی‌یار','چی می‌خوای بخری؟','مثلاً گوشی سامسونگ، شیائومی یا آیفون','دنبال لپ‌تاپ مناسب می‌گردی؟','اسم محصولت رو بنویس...','هر چی می‌خوای بنویس تا برات پیدا کنه'];
let i=0,timer;
