...
.v7-hooshyar-hint-inner{position:static!important;display:flex!important;align-items:center;justify-content:center;gap:6px;width:100%;min-width:0;direction:rtl}
.v7-hooshyar-hint-text{position:static!important;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.v7-hooshyar-bot{position:static!important;display:inline-flex!important;align-items:center;justify-content:center;flex:0 0 24px;width:24px;height:30px;font-size:18px;line-height:1;transform-origin:center;will-change:transform;animation:v7BotIdle 2.8s ease-in-out infinite}
.v7-hooshyar-bot svg{position:static!important;display:block;width:24px;height:30px;overflow:visible}
