...
.v7-hooshyar-action-zone .v5-smart-search-submit,.v7-hooshyar-action-zone .v5-smart-search-clear{position:static!important;align-items:center!important;justify-content:center!important;width:40px!important;height:40px!important;margin:0!important;padding:0!important;box-sizing:border-box!important;border:0!important;border-radius:10px!important;flex:none!important;background:transparent!important;transform:none!important}
.v7-hooshyar-action-zone .v5-smart-search-submit:not([hidden]),.v7-hooshyar-action-zone .v5-smart-search-clear:not([hidden]){display:flex!important}
.v7-hooshyar-action-zone .v5-smart-search-submit[hidden],.v7-hooshyar-action-zone .v5-smart-search-clear[hidden]{display:none!important;visibility:hidden!important}
...
function init(){const form=document.getElementById('v5SmartSearchForm'),input=document.getElementById('v5SmartSearchInput'),hint=document.getElementById('v5SmartSearchHint');if(!form||!input||!hint)return;const clear=document.getElementById('v5SmartSearchClear'),submit=form.querySelector('.v5-smart-search-submit');installCardStyle();const field=form.querySelector('.v5-smart-search-field');if(!field)return;
